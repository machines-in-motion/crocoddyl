...
#ifndef CROCODDYL_CORE_CONTROL_CONSTRAINT_HPP_
#define CROCODDYL_CORE_CONTROL_CONSTRAINT_HPP_
...
class ControlConstraintModelTpl : public ConstraintModelAbstractTpl<_Scalar>{
    ...
    public:
        ...
        typedef ControlConstraintDataTpl<Scalar> Data;
        typedef ConstraintDataAbstractTpl<Scalar> ConstraintDataAbstract;
        typedef typename MathBase::VectorXs VectorXs;
        typedef typename MathBase::MatrixXs MatrixXs;

    ControlConstraintModelTpl(boost::shared_ptr<typename Base::StateAbstract> state, std::size_t nu, 
                                                                    const VectorXs& lb, const VectorXs& ub);

    virtual ~ControlConstraintModelTpl();
...
template <typename _Scalar>
struct ControlConstraintDataTpl : public ConstraintDataAbstractTpl<_Scalar> {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  ControlConstraintDataTpl(Model<Scalar>* const model) : Base(model) {}
...
#include "crocoddyl/core/constraints/control_constraint.hxx"
