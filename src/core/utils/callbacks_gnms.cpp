...
CallbackVerboseGNMS::CallbackVerboseGNMS(VerboseLevel level) : CallbackVerbose(), level(level) {}

CallbackVerboseGNMS::~CallbackVerboseGNMS() {}

void CallbackVerboseGNMS::operator()(SolverAbstract& solver) {
